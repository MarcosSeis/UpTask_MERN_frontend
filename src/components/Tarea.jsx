  ...
  return (
    <div className="border-b p-5 flex justify-between items-center">
        ...
        <div className="flex flex-col lg:flex-row gap-2">
            {admin && (
                <button
                   className="bg-indigo-600 px-4 py-3 uppercase font-bold text-sm rounded-lg"
            ...
            <button
                className={`${estado ? 'bg-sky-600': 'bg-gray-600'} px-4 py-3 uppercase font-bold text-sm rounded-lg`}
           ...
           {admin && (
                <button
                    className="bg-red-600 px-4 py-3 uppercase font-bold text-sm rounded-lg"
