...
const Proyecto = () => {
  ...
  useEffect(() => {
    ...
    socket.on('tarea eliminada', tareaEliminada => {
      if(tareaEliminada.proyecto === proyecto.id){
  ...
  return (
        ...
        {admin && (
          ...
          type='button'
          className='text-sm px-5 py-3 w-full md:w-auto rounded-lg uppercase font-bold bg-sky-400 texxt-white text-center mt-5 flex gap-2 items-center'
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        ...
        <div className='flex items-center justify-between mt-10'>
          ...
          <Link 
            ...
            className='text-gray-400 font-bold text-xl hover:text-black'
            >
              Añadir
          </Link>
        </div>
